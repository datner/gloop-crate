...
export const GetKeplerVersions = GetGithubVersions('Sustainable Computing Kepler', 'sustainable-computing-io', 'kepler');

export const Kepler = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetKeplerVersions,
    org,
    distro,
