...
export const GetCleverVersions = GetGithubVersions('Sustainable Computing Clever', 'sustainable-computing-io', 'clever');

export const Clever = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetCleverVersions,
    org,
    distro,
