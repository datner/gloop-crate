...
export const GetKubernetesVersions = GetGithubVersions('kubernetes', 'kubernetes', 'kubernetes');

export const Kubernetes = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
