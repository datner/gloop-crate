...
export const GetAtlantisVersions = GetGithubVersions('Atlantis', 'runatlantis', 'atlantis');

export const Atlantis = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetAtlantisVersions,
    org,
    distro,
