...
export const GetVectorVersions = GetGithubVersions('Vector', 'vectordotdev', 'vector');

export const Vector = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetVectorVersions,
    org,
    distro,
