...
export const GetGitSignVersions = GetGithubVersions('gitsign', '', 'gitsign');

export const GitSign = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetGitSignVersions,
    org,
    distro,
