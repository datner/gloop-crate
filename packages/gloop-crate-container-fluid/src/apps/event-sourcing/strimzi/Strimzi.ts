...
export const GetStrimziVersions = GetGithubVersions('Strimzi', 'strimzi', 'strimzi-kafka-operator');

export const Strimzi = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetStrimziVersions,
    org,
    distro,
