...
export const GetSparkVersions = GetGithubVersions('Spark', 'apache', 'spark');

export const Spark = (org: string, distro: Distro, timestamp: number, version: O.Option<string> = O.some('latest')) =>
  GolangApp(
    GetSparkVersions,
    org,
    distro,
